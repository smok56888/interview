...
介绍业务，集中在RTA业务
rta 50ms性能指标怎么实现，垃圾回收这块的处理，g1回收比例怎么设计
rocksdb vs redis  rocks怎么高性能，底层的实现原理；redis集群相关知识
redis zset底层的实现原理， 跳表 vs b+树
sql慢查询怎么排查
算法：翻转字符串  "i am a student" -> "i ma a tneduts"
...
4、synchronize 关键字的原理、用法，与LOCK的实现有什么区别？
修饰static和非static的变量（方法）有何区别
5、JVM内存空间分配，GC过程，垃圾回收算法、垃圾回收器（CMS过程，G1过程，哪些阶段会STW）
线上集群的JVM内存配置
6、Redis vs Wtable
